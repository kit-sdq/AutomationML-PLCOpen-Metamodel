...
/**
 * This is the item provider adapter for a {@link org.plcopen.xml.tc60201.DataType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataType1ItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHandleUnknownPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType1_handleUnknown_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType1_handleUnknown_feature", "_UI_DataType1_type"),
				 Tc60201Package.eINSTANCE.getDataType1_HandleUnknown(),
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataType1_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataType1_name_feature", "_UI_DataType1_type"),
				 Tc60201Package.eINSTANCE.getDataType1_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
