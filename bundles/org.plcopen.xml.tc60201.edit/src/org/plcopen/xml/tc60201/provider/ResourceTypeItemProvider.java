...
/**
 * This is the item provider adapter for a {@link org.plcopen.xml.tc60201.ResourceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_globalId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_globalId_feature", "_UI_ResourceType_type"),
				 Tc60201Package.eINSTANCE.getResourceType_GlobalId(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Tc60201Package.eINSTANCE.getResourceType_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Tc60201Package.eINSTANCE.getResourceType_Task());
			childrenFeatures.add(Tc60201Package.eINSTANCE.getResourceType_GlobalVars());
			childrenFeatures.add(Tc60201Package.eINSTANCE.getResourceType_PouInstance());
			childrenFeatures.add(Tc60201Package.eINSTANCE.getResourceType_AddData());
			childrenFeatures.add(Tc60201Package.eINSTANCE.getResourceType_Documentation());
		}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Tc60201Package.eINSTANCE.getResourceType_Task(),
				 Tc60201Factory.eINSTANCE.createTaskType()));

		newChildDescriptors.add
			(createChildParameter
				(Tc60201Package.eINSTANCE.getResourceType_GlobalVars(),
				 Tc60201Factory.eINSTANCE.createVarList()));

		newChildDescriptors.add
			(createChildParameter
				(Tc60201Package.eINSTANCE.getResourceType_PouInstance(),
				 Tc60201Factory.eINSTANCE.createPouInstance()));

		newChildDescriptors.add
			(createChildParameter
				(Tc60201Package.eINSTANCE.getResourceType_AddData(),
				 Tc60201Factory.eINSTANCE.createAddData()));

		newChildDescriptors.add
			(createChildParameter
				(Tc60201Package.eINSTANCE.getResourceType_Documentation(),
