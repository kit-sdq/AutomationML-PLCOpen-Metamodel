...
/**
 * This is the item provider adapter for a {@link org.plcopen.xml.tc60201.EnumType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumTypeItemProvider 
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Tc60201Package.eINSTANCE.getEnumType_Values());
			childrenFeatures.add(Tc60201Package.eINSTANCE.getEnumType_BaseType());
		}
    ...
    public String getText(Object object) {
		return getString("_UI_EnumType_type");
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Tc60201Package.eINSTANCE.getEnumType_Values(),
				 Tc60201Factory.eINSTANCE.createValuesType()));

		newChildDescriptors.add
			(createChildParameter
				(Tc60201Package.eINSTANCE.getEnumType_BaseType(),
