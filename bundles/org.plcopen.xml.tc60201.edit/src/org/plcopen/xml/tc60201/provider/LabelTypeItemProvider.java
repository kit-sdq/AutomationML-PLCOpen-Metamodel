...
/**
 * This is the item provider adapter for a {@link org.plcopen.xml.tc60201.LabelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelTypeItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LabelType_executionOrderId_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LabelType_executionOrderId_feature", "_UI_LabelType_type"),
                 Tc60201Package.eINSTANCE.getLabelType_ExecutionOrderId(),
                 true,
                 false,
                 false,
    ...
    protected void addGlobalIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LabelType_globalId_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LabelType_globalId_feature", "_UI_LabelType_type"),
                 Tc60201Package.eINSTANCE.getLabelType_GlobalId(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 Tc60201Package.eINSTANCE.getLabelType_Height(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addLabelPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LabelType_label_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LabelType_label_feature", "_UI_LabelType_type"),
                 Tc60201Package.eINSTANCE.getLabelType_Label(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addLocalIdPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LabelType_localId_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LabelType_localId_feature", "_UI_LabelType_type"),
                 Tc60201Package.eINSTANCE.getLabelType_LocalId(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 Tc60201Package.eINSTANCE.getLabelType_Width(),
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(Tc60201Package.eINSTANCE.getLabelType_Position());
            childrenFeatures.add(Tc60201Package.eINSTANCE.getLabelType_AddData());
            childrenFeatures.add(Tc60201Package.eINSTANCE.getLabelType_Documentation());
        }
    ...
    public String getText(Object object) {
        BigInteger labelValue = ((LabelType)object).getExecutionOrderId();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (Tc60201Package.eINSTANCE.getLabelType_Position(),
                 Tc60201Factory.eINSTANCE.createPosition()));

        newChildDescriptors.add
            (createChildParameter
                (Tc60201Package.eINSTANCE.getLabelType_AddData(),
                 Tc60201Factory.eINSTANCE.createAddData()));

        newChildDescriptors.add
            (createChildParameter
                (Tc60201Package.eINSTANCE.getLabelType_Documentation(),
