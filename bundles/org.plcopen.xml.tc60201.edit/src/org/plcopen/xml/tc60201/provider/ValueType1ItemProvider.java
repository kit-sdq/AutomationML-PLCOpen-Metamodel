...
/**
 * This is the item provider adapter for a {@link org.plcopen.xml.tc60201.ValueType1} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueType1ItemProvider extends ValueItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRepetitionValuePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueType1_repetitionValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueType1_repetitionValue_feature", "_UI_ValueType1_type"),
				 Tc60201Package.eINSTANCE.getValueType1_RepetitionValue(),
				 true,
				 false,
				 false,
