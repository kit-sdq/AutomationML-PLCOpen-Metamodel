...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Variable Type5</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#getConnectionPointIn <em>Connection Point In</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#getConnectionPointOut <em>Connection Point Out</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#getEdge <em>Edge</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#getFormalParameter <em>Formal Parameter</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#isHidden <em>Hidden</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#isNegated <em>Negated</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.VariableType5Impl#getStorage <em>Storage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableType5Impl extends MinimalEObjectImpl.Container implements VariableType5 {
	/**
	...
	protected EClass eStaticClass() {
		return Tc60201Package.eINSTANCE.getVariableType5();
	}
	...
	public NotificationChain basicSetConnectionPointIn(ConnectionPointIn newConnectionPointIn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_IN, oldConnectionPointIn, newConnectionPointIn);
	...
	public void setConnectionPointIn(ConnectionPointIn newConnectionPointIn) {
		if (newConnectionPointIn != connectionPointIn) {
			...
			if (connectionPointIn != null)
				msgs = ((InternalEObject)connectionPointIn).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_IN, null, msgs);
			if (newConnectionPointIn != null)
				msgs = ((InternalEObject)newConnectionPointIn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_IN, null, msgs);
			msgs = basicSetConnectionPointIn(newConnectionPointIn, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_IN, newConnectionPointIn, newConnectionPointIn));
	}
	...
	public NotificationChain basicSetConnectionPointOut(ConnectionPointOut newConnectionPointOut, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_OUT, oldConnectionPointOut, newConnectionPointOut);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConnectionPointOut(ConnectionPointOut newConnectionPointOut) {
		if (newConnectionPointOut != connectionPointOut) {
			...
			if (connectionPointOut != null)
				msgs = ((InternalEObject)connectionPointOut).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_OUT, null, msgs);
			if (newConnectionPointOut != null)
				msgs = ((InternalEObject)newConnectionPointOut).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_OUT, null, msgs);
			msgs = basicSetConnectionPointOut(newConnectionPointOut, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_OUT, newConnectionPointOut, newConnectionPointOut));
	}
	...
	public NotificationChain basicSetDocumentation(FormattedText newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__DOCUMENTATION, oldDocumentation, newDocumentation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentation(FormattedText newDocumentation) {
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.VARIABLE_TYPE5__DOCUMENTATION, null, msgs);
			if (newDocumentation != null)
				msgs = ((InternalEObject)newDocumentation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.VARIABLE_TYPE5__DOCUMENTATION, null, msgs);
			msgs = basicSetDocumentation(newDocumentation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__DOCUMENTATION, newDocumentation, newDocumentation));
	}
	...
	public void setEdge(EdgeModifierType newEdge) {
		...
		edgeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__EDGE, oldEdge, edge, !oldEdgeESet));
	}
	...
	public void unsetEdge() {
		...
		edgeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Tc60201Package.VARIABLE_TYPE5__EDGE, oldEdge, EDGE_EDEFAULT, oldEdgeESet));
	}
	...
	public void setFormalParameter(String newFormalParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__FORMAL_PARAMETER, oldFormalParameter, formalParameter));
	}
	...
	public void setHidden(boolean newHidden) {
		...
		hiddenESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__HIDDEN, oldHidden, hidden, !oldHiddenESet));
	}
	...
	public void unsetHidden() {
		...
		hiddenESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Tc60201Package.VARIABLE_TYPE5__HIDDEN, oldHidden, HIDDEN_EDEFAULT, oldHiddenESet));
	}
	...
	public void setNegated(boolean newNegated) {
		...
		negatedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__NEGATED, oldNegated, negated, !oldNegatedESet));
	}
	...
	public void unsetNegated() {
		...
		negatedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Tc60201Package.VARIABLE_TYPE5__NEGATED, oldNegated, NEGATED_EDEFAULT, oldNegatedESet));
	}
	...
	public void setStorage(StorageModifierType newStorage) {
		...
		storageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.VARIABLE_TYPE5__STORAGE, oldStorage, storage, !oldStorageESet));
	}
	...
	public void unsetStorage() {
		...
		storageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Tc60201Package.VARIABLE_TYPE5__STORAGE, oldStorage, STORAGE_EDEFAULT, oldStorageESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_IN:
				return basicSetConnectionPointIn(null, msgs);
			case Tc60201Package.VARIABLE_TYPE5__CONNECTION_POINT_OUT:
				return basicSetConnectionPointOut(null, msgs);
			case Tc60201Package.VARIABLE_TYPE5__DOCUMENTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Tc60201Package.VARIABLE_TYPE5__EDGE:
				return getEdge();
			case Tc60201Package.VARIABLE_TYPE5__FORMAL_PARAMETER:
				return getFormalParameter();
			case Tc60201Package.VARIABLE_TYPE5__HIDDEN:
				return isHidden();
			case Tc60201Package.VARIABLE_TYPE5__NEGATED:
				return isNegated();
			case Tc60201Package.VARIABLE_TYPE5__STORAGE:
				return getStorage();
		}
