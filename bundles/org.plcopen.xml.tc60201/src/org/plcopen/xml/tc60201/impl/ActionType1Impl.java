 ...
 * </p>
 * <ul>
 *   <li>{@link org.plcopen.xml.tc60201.impl.ActionType1Impl#getBody <em>Body</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.ActionType1Impl#getAddData <em>Add Data</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.ActionType1Impl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.ActionType1Impl#getGlobalId <em>Global Id</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.ActionType1Impl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionType1Impl extends MinimalEObjectImpl.Container implements ActionType1 {
    ...
    public NotificationChain basicSetBody(Body newBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.ACTION_TYPE1__BODY, oldBody, newBody);
    ...
    public void setBody(Body newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.ACTION_TYPE1__BODY, null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.ACTION_TYPE1__BODY, null, msgs);
    ...
    public NotificationChain basicSetAddData(AddData newAddData, NotificationChain msgs) {
		...
		addData = newAddData;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.ACTION_TYPE1__ADD_DATA, oldAddData, newAddData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void setAddData(AddData newAddData) {
		if (newAddData != addData) {
			NotificationChain msgs = null;
			if (addData != null)
				msgs = ((InternalEObject)addData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.ACTION_TYPE1__ADD_DATA, null, msgs);
			if (newAddData != null)
				msgs = ((InternalEObject)newAddData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.ACTION_TYPE1__ADD_DATA, null, msgs);
    ...
    public NotificationChain basicSetDocumentation(FormattedText newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.ACTION_TYPE1__DOCUMENTATION, oldDocumentation, newDocumentation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
    ...
    public void setDocumentation(FormattedText newDocumentation) {
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.ACTION_TYPE1__DOCUMENTATION, null, msgs);
			if (newDocumentation != null)
				msgs = ((InternalEObject)newDocumentation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.ACTION_TYPE1__DOCUMENTATION, null, msgs);
