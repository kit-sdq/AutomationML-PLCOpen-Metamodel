...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Connection Point Out Type2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.plcopen.xml.tc60201.impl.ConnectionPointOutType2Impl#getFormalParameter <em>Formal Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionPointOutType2Impl extends ConnectionPointOutImpl implements ConnectionPointOutType2 {
    /**
	 ...
	 * @generated
	 */
    protected ConnectionPointOutType2Impl() {
		super();
	}
    ...
    protected EClass eStaticClass() {
		return Tc60201Package.eINSTANCE.getConnectionPointOutType2();
	}
    ...
    public void setFormalParameter(String newFormalParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.CONNECTION_POINT_OUT_TYPE2__FORMAL_PARAMETER, oldFormalParameter, formalParameter));
	}
