...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Connection Point Out Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.plcopen.xml.tc60201.impl.ConnectionPointOutTypeImpl#getFormalParameter <em>Formal Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionPointOutTypeImpl extends ConnectionPointOutImpl implements ConnectionPointOutType {
    /**
     ...
     * @generated
     */
    protected ConnectionPointOutTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return Tc60201Package.eINSTANCE.getConnectionPointOutType();
    }
    ...
    public void setFormalParameter(String newFormalParameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.CONNECTION_POINT_OUT_TYPE__FORMAL_PARAMETER, oldFormalParameter, formalParameter));
    }
