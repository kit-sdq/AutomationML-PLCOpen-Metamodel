...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>In Variable Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getConnectionPointOut <em>Connection Point Out</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getAddData <em>Add Data</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getEdge <em>Edge</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getExecutionOrderId <em>Execution Order Id</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getGlobalId <em>Global Id</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getLocalId <em>Local Id</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#isNegated <em>Negated</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getStorage <em>Storage</em>}</li>
 *   <li>{@link org.plcopen.xml.tc60201.impl.InVariableTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InVariableTypeImpl extends MinimalEObjectImpl.Container implements InVariableType {
	/**
	...
	protected EClass eStaticClass() {
		return Tc60201Package.eINSTANCE.getInVariableType();
	}
	...
	public NotificationChain basicSetPosition(Position newPosition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__POSITION, oldPosition, newPosition);
	...
	public void setPosition(Position newPosition) {
		if (newPosition != position) {
			...
			if (position != null)
				msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__POSITION, null, msgs);
			if (newPosition != null)
				msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__POSITION, null, msgs);
			msgs = basicSetPosition(newPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__POSITION, newPosition, newPosition));
	}
	...
	public NotificationChain basicSetConnectionPointOut(ConnectionPointOut newConnectionPointOut, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__CONNECTION_POINT_OUT, oldConnectionPointOut, newConnectionPointOut);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConnectionPointOut(ConnectionPointOut newConnectionPointOut) {
		if (newConnectionPointOut != connectionPointOut) {
			...
			if (connectionPointOut != null)
				msgs = ((InternalEObject)connectionPointOut).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__CONNECTION_POINT_OUT, null, msgs);
			if (newConnectionPointOut != null)
				msgs = ((InternalEObject)newConnectionPointOut).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__CONNECTION_POINT_OUT, null, msgs);
			msgs = basicSetConnectionPointOut(newConnectionPointOut, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__CONNECTION_POINT_OUT, newConnectionPointOut, newConnectionPointOut));
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__EXPRESSION, oldExpression, expression));
	}
	...
	public NotificationChain basicSetAddData(AddData newAddData, NotificationChain msgs) {
		...
		addData = newAddData;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__ADD_DATA, oldAddData, newAddData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAddData(AddData newAddData) {
		if (newAddData != addData) {
			NotificationChain msgs = null;
			if (addData != null)
				msgs = ((InternalEObject)addData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__ADD_DATA, null, msgs);
			if (newAddData != null)
				msgs = ((InternalEObject)newAddData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__ADD_DATA, null, msgs);
			msgs = basicSetAddData(newAddData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__ADD_DATA, newAddData, newAddData));
	}
	...
	public NotificationChain basicSetDocumentation(FormattedText newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__DOCUMENTATION, oldDocumentation, newDocumentation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentation(FormattedText newDocumentation) {
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__DOCUMENTATION, null, msgs);
			if (newDocumentation != null)
				msgs = ((InternalEObject)newDocumentation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tc60201Package.IN_VARIABLE_TYPE__DOCUMENTATION, null, msgs);
			msgs = basicSetDocumentation(newDocumentation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__DOCUMENTATION, newDocumentation, newDocumentation));
	}
	...
	public void setEdge(EdgeModifierType newEdge) {
		...
		edgeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__EDGE, oldEdge, edge, !oldEdgeESet));
	}
	...
	public void unsetEdge() {
		...
		edgeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Tc60201Package.IN_VARIABLE_TYPE__EDGE, oldEdge, EDGE_EDEFAULT, oldEdgeESet));
	}
	...
	public void setExecutionOrderId(BigInteger newExecutionOrderId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__EXECUTION_ORDER_ID, oldExecutionOrderId, executionOrderId));
	}
	...
	public void setGlobalId(String newGlobalId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__GLOBAL_ID, oldGlobalId, globalId));
	}
	...
	public void setHeight(BigDecimal newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__HEIGHT, oldHeight, height));
	}
	...
	public void setLocalId(BigInteger newLocalId) {
		...
		localId = newLocalId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__LOCAL_ID, oldLocalId, localId));
	}
	...
	public void setNegated(boolean newNegated) {
		...
		negatedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__NEGATED, oldNegated, negated, !oldNegatedESet));
	}
	...
	public void unsetNegated() {
		...
		negatedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Tc60201Package.IN_VARIABLE_TYPE__NEGATED, oldNegated, NEGATED_EDEFAULT, oldNegatedESet));
	}
	...
	public void setStorage(StorageModifierType newStorage) {
		...
		storageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__STORAGE, oldStorage, storage, !oldStorageESet));
	}
	...
	public void unsetStorage() {
		...
		storageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Tc60201Package.IN_VARIABLE_TYPE__STORAGE, oldStorage, STORAGE_EDEFAULT, oldStorageESet));
	}
	...
	public void setWidth(BigDecimal newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tc60201Package.IN_VARIABLE_TYPE__WIDTH, oldWidth, width));
	}
